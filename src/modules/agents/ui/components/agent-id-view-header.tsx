    ...
    <div className="flex items-center justify-between pb-2 border-b border-[#412D15]/10 select-none">
      ...
      <DropdownMenu modal={false}>
        ...
        >
          ...
          <DropdownMenuItem 
            onClick={onRemove}
            className="cursor-pointer flex items-center gap-x-2 font-bold p-2.5 rounded-lg hover:bg-[#D8D1BE]/75 focus:bg-[#D8D1BE]/75 text-sm text-[#B54747] focus:text-[#B54747] transition-all duration-150"
          >
